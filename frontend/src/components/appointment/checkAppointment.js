              ...
              <div>
                <div className="rounded-lg shadow-lg border-r-2 p-3">
                  ...
                  <p className="font-thin text-justify">
                    lorempipEu quis non sunt pariatur ut sint incididunt
                    excepteur.Proident adipisicing exercitation anim
                    nulla.Cupidatat duis voluptate elit et.Minim cillum anim et
                    incididunt consequat occaecat.Culpa ipsum duis ullamco ut
                    ipsum nulla anim fugiat ipsum sunt.Sunt consectetur velit
                    velit adipisicing.{" "}
                  </p>{" "}
