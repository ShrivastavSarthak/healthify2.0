        ...
        <div className=" grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
          <div className="overflow-hidden">
            ...
            >
              <Image
                preview={false}
                src="https://images.unsplash.com/photo-1579455150073-3a7974b46aa0?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D "
              />
            </motion.div>{" "}
          </div>{" "}
          <motion.div
          ...
          >
            <h1 className=" font-bold text-5xl"> 7 Most effective Exercise </h1>{" "}
            <h3 className="   font-bold text-lg">
              {" "}
              What are the some of the best exercise ? Fitness experts offer a
              list of the top moves to get a good workout{" "}
            </h3>{" "}
          </motion.div>{" "}
        </div>{" "}
      </button>{" "}
          ...
          <div className=" grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 xs:grid-cols-1">
            <div className="overflow-hidden">
              ...
              >
                <Image
                  preview={false}
                  src="https://images.unsplash.com/photo-1527137342181-19aab11a8ee8?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D "
                />
              </motion.div>{" "}
            </div>{" "}
            <motion.div
