...
function ExercisePage() {
  ...
  const [isExercise, setIsExercise] = useState(data);
  ...
  return (
    <div className="container mx-auto my-[6%]">
      ...
      {Array.isArray(isExercise) &&
        isExercise.map((item, index) => (
          <div className="">
            <h3 className="font-bold color-[#28267d] text-xl mt-4">
              {" "}
              {item.name}{" "}
            </h3>{" "}
            ...
            <div>
              ...
              <div className=" flex gap-3">
                ...
                {isExercise[index].muscles_targeted.map((item, index) => (
              ...
              <h3 className="text-justify"> {item.instructions} </h3>{" "}
            </div>{" "}
          </div>
        ))}{" "}
    </div>
